...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train and evaluate an LSTM model.")
    ...
    data_loader = DataLoader(batch_size=batch_size, seq_length=seq_length, data_dir = args.data_file)
    test_data_loader = DataLoader(batch_size=batch_size, seq_length=seq_length, data_dir = args.data_file, train=False)
    ...
    tracker.save_model(args.output_model)
